...
import '../models/transaktions_list.dart';
...
class _TransktionPageState extends State<TransaktionsPageAdmin> {
  ...
  Future<void> getSellTransaction() async {
    ...
    final response = await http.get(Uri.parse(
        'https://abu-saxi-production.up.railway.app/getUserProductSell?months=$_selectedMenu&userId=$userId&sells=all'));
  ...
  Future<void> deleteSellTransaction(String transactionId) async {
    final response = await http.delete(Uri.parse(
        'https://abu-saxi-production.up.railway.app/deleteSellTransaction?transactionid=$transactionId'));
    final data = jsonDecode(response.body);
