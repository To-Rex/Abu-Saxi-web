import 'dart:async';
import 'dart:convert';
import 'package:abu_saxi_web/admin/transaction_product_page.dart';
import 'package:abu_saxi_web/admin/user_page.dart';
...
class _ProductPageState extends State<ProductPage>
  ...
  Future<void> _getProductsByCategory() async {
    ...
    final response = await http.get(
      Uri.parse(
          'https://abu-saxi-production.up.railway.app/getProductsByCategory?categoryId=$catId'),
    );
  ...
  Future<void> _addProduct() async {
    ...
    final response = await http.post(
      Uri.parse(
          'https://abu-saxi-production.up.railway.app/addProduct'),
  ...
  Future<void> _sellProduct(String productId) async {
    ...
    final response = await http.post(
      Uri.parse(
          'https://abu-saxi-production.up.railway.app/productSell?productId=$productId&userId=$userId&number=$number'),
      body: {
  ...
  Future<void> _sellProductPrise(String productId) async {
    ...
    final response = await http.post(
      Uri.parse(
          'https://abu-saxi-production.up.railway.app/addProductSellPrice?productId=$productId&userId=$userId&number=$number'),
      body: {
        'addition_price': _productPriceController.text,
      },
    );
  ...
  Future<void> _updateProduct(String productId) async {
    ...
    final response = await http.put(
      Uri.parse(
          'https://abu-saxi-production.up.railway.app/updateProduct?productId=$productId'),
      body: jsonEncode(<Object, Object>{
        'product_name': _productNameController.text,
        'product_desc': _productDescriptionController.text,
        'product_price': price,
  ...
  Future<void> _putPraductSell(String productId, String productName) async {
    ...
    final response = await http.post(
      Uri.parse(
          'https://abu-saxi-production.up.railway.app/addProductSell?productId=$productId&number=$number&userId=$userId'),
      body: {
  ...
  Future<void> _deleteProduct(String productId) async {
    ...
    final response = await http.delete(
      Uri.parse(
          'https://abu-saxi-production.up.railway.app/deleteProduct?productId=$productId'),
    );
    if (response.statusCode == 200) {
      final data = jsonDecode(response.body);
      if (data['status'] == 'success') {
