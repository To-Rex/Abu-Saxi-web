...
import 'package:abu_saxi_web/admin/transaction_page.dart';
import 'package:abu_saxi_web/admin/transaktion_page_admin.dart';
...
import '../user/transaktion_page.dart';
...
class _UserPageState extends State<UserPage>
  ...
  Future<void> _getUsers() async {
    var url = Uri.parse('https://abu-saxi-production.up.railway.app/getAllUser');
  ...
  Future<void> _addUser() async {
    final response = await http.post(
      Uri.parse(
          'https://abu-saxi-production.up.railway.app/register'),
  ...
  Future<void> _deleteUser(String userId) async {
    var url = Uri.parse(
        'https://abu-saxi-production.up.railway.app/deleteUser?userid=$userId');
  ...
  Future<void> _updateBlocked(String userNames, bool blocked) async {
    var response = await http.put(
        Uri.parse(
            'https://abu-saxi-production.up.railway.app/updateBlocked'),
        body: jsonEncode(<Object, Object>{
          'username': userNames,
          'blocked': blocked,
        }));
  ...
  Future<void> _updateUser(String userId) async {
    var response = await http.put(
        Uri.parse(
            'https://abu-saxi-production.up.railway.app/updateUser?userId=$userId'),
        body: jsonEncode(<Object, Object>{
          'username': _userNameController.text,
          'name': _nameController.text,
          'surname': _surNameController.text,
  ...
  Future<void> _updateUserPassword(String userNames) async {
    var response = await http.put(
        Uri.parse(
            'https://abu-saxi-production.up.railway.app/updatePassword'),
        body: jsonEncode(<Object, Object>{
          'username': userNames,
          'password': _passwordController.text,
        }));
  ...
  Future<void> _updateUserRole(String userNames, String roles) async {
    var response = await http.put(
        Uri.parse(
            'https://abu-saxi-production.up.railway.app/updateUserRole'),
        body: jsonEncode(<Object, Object>{
          'username': userNames,
          'user_role': roles,
        }));
